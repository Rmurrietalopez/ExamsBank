...
export default function ReadingExam4WelcomePage() {
  const router = useRouter();
  const { startExam } = useReadingExam(); // ✅ if your hook has startExam, this stays
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      router.push('/reading/exam4/ex1');
    } catch (err) {
      console.error('Error starting Reading Exam 4:', err);
