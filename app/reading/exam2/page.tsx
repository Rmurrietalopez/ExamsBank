...
export default function ReadingExam2WelcomePage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      router.push('/reading/exam2/ex1');
    } catch (err) {
      console.error('Error starting Reading Exam 2:', err);
      ...
      <div className="w-full max-w-2xl bg-[#fffcf9] border border-[#c4baad] shadow-xl rounded-3xl p-8 md:p-10 space-y-6">
        ...
        <header className="space-y-2">
          ...
          <p className="text-sm md:text-base text-gray-800">
            This exam continues your practice for the{' '}
            <strong>CELPIP Reading</strong> section. Please enter your details
            before starting. Your teacher will see your results in the Go
            CELPIP dashboard.
          </p>
        </header>
